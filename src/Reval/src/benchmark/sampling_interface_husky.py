...
def turtlebot():
    rospy.init_node('husky_config_py', anonymous=True)
    turtlebot_config = '../../config/husky_config_random-constant.yaml'
    ...
    load_config.load_config(turtlebot_config, 'Husky')
    ...
    log_config.to_csv("log/config_husky.csv", index=False, header=True)
